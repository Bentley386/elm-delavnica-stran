...
var $author$project$User$initialUsers = _List_fromArray(
	[
		{name: 'Name 1', point: 12, uid: 1},
		{name: 'Name 2', point: 17, uid: 2},
		{name: 'Boštjan', point: 100, uid: 3},
		{name: 'Andrej', point: 200, uid: 4},
		{name: 'Marko', point: 200, uid: 5},
		{name: 'Matej', point: 200, uid: 6},
		{name: 'Nevem', point: 200, uid: 7}
	]);
...
var $author$project$User$remove = F2(
	function (user, users) {
		remove:
		while (true) {
			if (!users.b) {
				...
				if (_Utils_eq(usr.uid, user.uid)) {
					...
					return A2(
						$elm$core$List$cons,
						usr,
						A2($author$project$User$remove, user, rest));
				}
			}
		}
	});
var $author$project$App$sendAlert = _Platform_outgoingPort('sendAlert', $elm$json$Json$Encode$string);
			...
			case 'DeleteUser':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							users: A2($author$project$User$remove, user, model.users)
						}),
					$author$project$App$sendAlert(user.name));
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$App$Random = {$: 'Random'};
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$App$Reset)
								]))
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$App$Random)
								]))
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Zbriši juzerja')
								]))
						]))
				]),
			A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$elm$core$String$fromInt(user.point))
									])),
								A2(
								$rundis$elm_bootstrap$Bootstrap$Grid$col,
								_List_Nil,
									...
									[
										...
										_List_fromArray(
											[
												...
												$author$project$App$DeleteUser(user))
											]),
										_List_fromArray(
											[
...
_Platform_export({'App':{'init':$author$project$App$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"App.Msg","aliases":{"User.User":{"args":[],"type":"{ uid : Basics.Int, name : String.String, point : Basics.Int }"}},"unions":{"App.Msg":{"args":[],"tags":{"Initialize":[],"Increment":[],"Decrement":[],"Reset":[],"Random":[],"DeleteUser":["User.User"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));